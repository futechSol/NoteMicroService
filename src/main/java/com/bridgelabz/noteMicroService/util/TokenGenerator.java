...
import com.bridgelabz.noteMicroService.exception.TokenException;
...
public class TokenGenerator {
	...
	public long retrieveIdFromToken(String token) {
		...
		try {
			...
			throw new TokenException(Integer.parseInt(environment.getProperty("status.token.errorCode")), e.getMessage());
		}
	}
}
